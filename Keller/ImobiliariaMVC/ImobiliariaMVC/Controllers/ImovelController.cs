...
namespace ImobiliariaMVC.Controllers
{
    public class ImovelController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeImovelVendendo,Valor,NomeImovelComprando,ValorDisponivel,ClienteId")] Imovel imovel)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.CLIENTES, "Id", "Id", imovel.ClienteId);
            return View(imovel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeImovelVendendo,Valor,NomeImovelComprando,ValorDisponivel,ClienteId")] Imovel imovel)
        {
            if (id != imovel.Id)
            {
                return NotFound();
