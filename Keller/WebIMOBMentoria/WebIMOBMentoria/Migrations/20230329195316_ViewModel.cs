...
namespace WebIMOBMentoria.Migrations
{
    /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImovelId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImovelNomeVenda = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ValorDoImovel = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ImovelNomeCompra = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClienteId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
