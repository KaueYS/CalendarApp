...
namespace WebIMOBMentoria.Controllers
{
    ...
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,ClienteNome,Email,Telefone")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,ClienteNome,Email,Telefone")] Cliente cliente)
        {
