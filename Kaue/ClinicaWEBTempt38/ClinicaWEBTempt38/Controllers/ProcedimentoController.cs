...
namespace ClinicaWEBTempt38.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoPreco,Criado")] Procedimento procedimento)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoPreco,Criado")] Procedimento procedimento)
        {
