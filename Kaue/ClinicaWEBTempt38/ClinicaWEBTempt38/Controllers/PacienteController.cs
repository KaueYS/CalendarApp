...
namespace ClinicaWEBTempt38.Controllers
{
    public class PacienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,Nome,Email,Telefone")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,Nome,Email,Telefone")] Paciente paciente)
        {
